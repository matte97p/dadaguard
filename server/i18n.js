...
const S = {
  it: {
    ...
    // Target che entrano o escono a fine rilascio: non contati fra i sani né fra i rotti, ma detti,
    // altrimenti «2/2 target sani» durante un deploy nasconde che ce n'è un terzo che sta uscendo.
    'alb.transitioning': ' · {n} in transizione',
    'alb.alltransitioning': 'tutti i target in transizione ({n}): rilascio in corso',
  ...
  en: {
    ...
    'alb.transitioning': ' · {n} in transition',
    'alb.alltransitioning': 'all targets in transition ({n}): deployment in progress',
