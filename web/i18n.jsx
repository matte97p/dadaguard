...
const STRINGS = {
  it: {
    ...
    'costs.cat.desc': 'Ripartizione per la Cost Category «{cat}» (compute, database, llms…). Il menu «Livello» in alto filtra tutta la pagina, come su Analytics.',
  ...
  en: {
    ...
    'costs.cat.desc': 'Breakdown by the «{cat}» cost category (compute, database, llms…). The «Level» menu at the top filters the whole page, as on Analytics.',
