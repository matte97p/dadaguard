...
const STRINGS = {
  it: {
    ...
    // Esecuzioni (pagina Esecuzioni): una riga = una corsa. Il vocabolario è quello di chi guarda un
    // job lungo — «in corso», «da quanto», «com'è finita» — non quello delle API che lo raccontano.
    'runs.title': 'Esecuzioni',
    'runs.desc': 'Cosa sta girando adesso e com’è finita ogni singola corsa: per ogni cron le ultime esecuzioni, con i log della singola corsa invece dell’ultima ora del job. La finestra è un tetto: un cron frequente riempie la lista con le sue ultime run.',
    ...
    'runs.allTitle': 'Cron e ultime corse',
    'runs.listTitle': 'Esecuzioni',
    'runs.widthIsDuration': 'la larghezza del blocco è la durata',
    'runs.nextAt': 'prossima {time}',
    'runs.openLogs': 'clic per i log di questa corsa',
    ...
    'runs.noRunTitle': 'Non hanno corso nella finestra ({n})',
    'runs.neverRan': 'non è partito',
    'runs.disabled': 'spento',
    'runs.updated': 'aggiornato {ago}',
    'runs.refreshing': 'aggiorno…',
  ...
  en: {
    ...
    'runs.title': 'Runs',
    'runs.desc': 'What is running right now and how each single execution ended: the latest runs per cron, with logs scoped to one run instead of the job’s last hour. The window is a ceiling — a frequent cron fills the list with its own recent runs.',
    ...
    'runs.noRunTitle': 'Did not run in the window ({n})',
