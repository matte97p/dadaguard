...
const STRINGS = {
  it: {
    ...
    'topo.tab.net': 'Rete',
    'topo.desc':
      'Relazioni dedotte da AWS (env Lambda/ECS, event source, Step Functions, load balancer, security group) — niente da dichiarare a mano. Le frecce sono «dipende da»; il colore dice come l’abbiamo capita. Se una dipendenza è giù l’arco diventa rosso.',
  ...
  en: {
    ...
    'topo.desc':
      'Relations inferred from AWS (Lambda/ECS env, event sources, Step Functions, load balancers, security groups) — nothing to declare by hand. Arrows mean «depends on»; the color says how we inferred it. If a dependency is down the edge turns red.',
